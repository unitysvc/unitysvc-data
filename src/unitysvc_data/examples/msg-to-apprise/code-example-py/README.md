+++
preset_name = "msg_to_apprise_code_example_py"
...
# msg-to-apprise / code-example-py
...
each variant becomes its own preset (e.g. `msg_to_apprise_code_example_py_discord`).
