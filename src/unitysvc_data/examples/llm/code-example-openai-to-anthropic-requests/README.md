+++
preset_name = "llm_code_example_openai_to_anthropic_requests"
...
is_active = true
is_public = true
meta = { variant = "OpenAI-style", requirements = ["requests"], min_expected_metrics = { input_tokens = 1, output_tokens = 1 } }
